R = 0.5;// define the radius of circle
L = 2.0;//
...
Transfinite Line{1, 2, 3, 4, 5, 6, 7} = 10;// define the length of line

Transfinite Surface{1};//参数化 可以用 10 Using Progression 1 来定义
...
//+
Physical Curve("arc", 12) = {2, 1};
//+
Physical Surface("surface", 13) = {1, 2};
